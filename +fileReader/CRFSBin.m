...
function [specData, idx] = Fcn_BinInfo(specData, ThreadID, DataType, Description, FreqStart, FreqStop, Resolution, Threshold, AntennaID, TraceID, UnitID, NDATA)
    ...
    Bin            = struct(class.MetaDataList);
    Bin.DataType   = DataType;
    Bin.FreqStart  = FreqStart;
    Bin.FreqStop   = FreqStop;
    Bin.LevelUnit  = UnitID;
    Bin.DataPoints = NDATA;
    Bin.Resolution = Resolution;
    Bin.Threshold  = Threshold;
    Bin.TraceMode  = TraceID;
    Bin.Antenna    = AntennaID;
