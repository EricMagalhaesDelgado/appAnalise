    ...
    methods (Access = private)
        ...
        function plot_Points(app, hAxes)
            ...
            for ii = 1:height(app.pointsTable)
                ...
                switch app.pointsTable.type{ii}
                    case 'RFDataHub'
                        Coordinates = [app.pointsTable.value(ii).Data.Latitude, app.pointsTable.value(ii).Data.Longitude];
                    ...
                    case 'FindPeaks'
                        Coordinates = app.pointsTable.value(ii).Data;
